...
/*                                                                        */
/* $Source: public/src/import/public/common/generic/fapi2/src/error_info.C $ */
/*                                                                        */
        ...
        const void* const* i_object) const
{
    ...
    FAPI_DBG("addErrorInfo: Adding hw callout target: %s hw: %d, pri: %d, pos: %d",
             target_path, ei->iv_hw, ei->iv_calloutPriority, ei->iv_clkPos);
