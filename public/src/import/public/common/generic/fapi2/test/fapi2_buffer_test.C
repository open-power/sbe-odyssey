...
/*                                                                        */
/* $Source: public/src/import/public/common/generic/fapi2/test/fapi2_buffer_test.C $ */
/*                                                                        */
...
TEST_CASE("Test non-template getBit Bit API")
{
    ...
    {
        // Multiple bit value test
        fapi2::buffer<uint64_t> test1(0x0030000000000000);
        fapi2::buffer<uint64_t> test2(0x0300000000000000);

        REQUIRE( (test1.getBits<8, 4>()) == 0x3 );
        REQUIRE( (test1.getBits<8, 4>()) == test2.getBits(4, 4) );
    }
}
