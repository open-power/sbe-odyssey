...
#
# $Source: public/src/import/public/systems/common/hdct/pymod/createHdctTxtUtils.py $
#
...
class HDCTBinEntry():
    ...
    def printSingleEntry(self):
        ...
        out.debug(" ")
        out.debug("Additional Details: %s " % self.addDetails)
        out.debug(" ")
    ...
    while True:
        ...
        if((genericVal != b'')):
            ...
            if(cmdTxt == 'gettracearray') or (cmdTxt == 'getring') or (cmdTxt == 'stopclocks') or (cmdTxt == 'getfastarray'):
                ...
                # String values are not required in ppe/sbe test case
                if parserUsage != "ppe":
