...
/*                                                                        */
/* $Source: public/src/import/public/memory/common/pmic/tests/pmic_mss_ut.C $ */
/*                                                                        */
...
///
/// @file chips/ocmb/common/procedures/hwp/pmic/lib/tests/pmic_mss_ut.C
...
#include <generic/memory/proc_specific/tests/exp_mss_reset_attrs_ut.H>
...
int main(int i_argc, char* i_argv[])
{
    ...
    for( const auto& ecmd_target : l_ecmd_targets )
    {
        ...
        for( const auto& l_ocmb : mss::find_targets<fapi2::TARGET_TYPE_OCMB_CHIP>(l_proc))
        {
