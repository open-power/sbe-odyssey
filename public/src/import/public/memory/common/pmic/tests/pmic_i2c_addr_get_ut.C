...
SCENARIO_METHOD(ocmb_chip_target_test_fixture, "Test PMIC i2c address getter", "[pmic_i2c_addr_get]")
{
    ...
    {
        // Arbitrary values
        uint8_t SAMPLE_I2C_ADDR0 = 0xCE;
        uint8_t SAMPLE_I2C_ADDR1 = 0xF0;
        uint8_t SAMPLE_I2C_ADDR2 = 0x52;
        uint8_t SAMPLE_I2C_ADDR3 = 0xB3;

        // Arbitrary length
        uint8_t l_fake_spd[300] = {0};

        FAPI_INF("Test pmic i2c DDR4 address");
        ...
        // Test for DDR5
        FAPI_INF("Test pmic i2c DDR5 address");

        SAMPLE_I2C_ADDR0 = 0x58;
        SAMPLE_I2C_ADDR1 = 0x59;
        SAMPLE_I2C_ADDR2 = 0x5A;
        SAMPLE_I2C_ADDR3 = 0x5B;

        l_fake_spd[DDIMM_SPD::DDR_BYTE] = DDIMM_SPD::MEM_DDR5;

        l_fake_spd[SPD_PMIC0_I2C_BYTE_DDR5] = SAMPLE_I2C_ADDR0;
        l_fake_spd[SPD_PMIC1_I2C_BYTE_DDR5] = SAMPLE_I2C_ADDR1;
        l_fake_spd[SPD_PMIC2_I2C_BYTE_DDR5] = SAMPLE_I2C_ADDR2;
        l_fake_spd[SPD_PMIC3_I2C_BYTE_DDR5] = SAMPLE_I2C_ADDR3;
