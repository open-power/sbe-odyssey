...
/*                                                                        */
/* $Source: public/src/import/public/memory/common/pmic/lab/tools/pmic_power_down_wrap.C $ */
/*                                                                        */
...
///
/// @file pmic_power_down_wrap.C
/// @brief Wrapper for calling pmic_power_down
///
...
static const std::string PROCEDURE = "pmic_power_down_wrap";
void help()
{
    // procedure constants
    ...
    do
    {
        ...
        while (ecmdConfigLooperNext(node_target, node_looper))
        {
            ...
            while(ecmdConfigLooperNext(l_ocmb_target, ocmb_looper))
            {
                ...
                rc = mss::pmic::pmic_power_down(fapi_target);
