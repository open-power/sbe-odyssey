...
/*                                                                        */
/* $Source: public/src/import/public/memory/common/pmic/wrapper/pmic_enable_wrap.C $ */
/*                                                                        */
...
///
/// @file pmic_enable_wrap.C
/// @brief Wrapper for calling pmic_enable
///
...
static const std::string PROCEDURE = "pmic_enable_wrap";
void help()
{
    // procedure constants
...
int main(int argc, char* argv[])
{
    ...
    do
    {
        ...
        while (ecmdConfigLooperNext(node_target, node_looper))
        {
            ...
            l_ocmb_target.chipType = "explorer";
            ...
            while(ecmdConfigLooperNext(l_ocmb_target, ocmb_looper))
            {
                ...
                rc_fapi = mss::pmic::ddr4::pmic_enable(fapi_target, mode);
