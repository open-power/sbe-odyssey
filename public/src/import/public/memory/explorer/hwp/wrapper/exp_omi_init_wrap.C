...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_omi_init_wrap.C $ */
/*                                                                        */
...
/// @file exp_omi_init_wrap.C
/// @brief Wrapper for calling exp_omi_init hwp
///
...
static const std::string PROCEDURE = "exp_omi_init_wrap";
void help()
{
    // procedure constants
