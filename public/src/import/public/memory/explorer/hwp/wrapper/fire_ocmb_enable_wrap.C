...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/fire_ocmb_enable_wrap.C $ */
/*                                                                        */
...
/// @file fire_ocmb_enable_wrap.C
/// @brief Wrapper for calling fire_ocmb_enable hwp
///
...
static const std::string PROCEDURE = "fire_ocmb_enable_wrap";
void help()
{
    // procedure constants
