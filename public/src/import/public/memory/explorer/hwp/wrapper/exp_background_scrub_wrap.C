...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_background_scrub_wrap.C $ */
/*                                                                        */
...
/// @file exp_background_scrub_wrap.C
/// @brief Wrapper for calling exp_background_scrub hwp
///
...
static const std::string PROCEDURE = "exp_background_scrub_wrap";
void help()
{
    // build help message
    char outstr[256];
