...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_omi_setup_wrap.C $ */
/*                                                                        */
...
/// @file exp_omi_setup_wrap.C
/// @brief Wrapper for calling exp_omi_setup hwp
///
...
static const std::string PROCEDURE = "exp_omi_setup_wrap";
void help()
{
    // procedure constants
