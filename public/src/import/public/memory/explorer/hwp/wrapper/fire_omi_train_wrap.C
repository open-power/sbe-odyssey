...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/fire_omi_train_wrap.C $ */
/*                                                                        */
...
/// @file fire_omi_setup_wrap.C
/// @brief Wrapper for calling fire_omi_train hwp
///
...
static const std::string PROCEDURE = "fire_omi_train_wrap";
void help()
{
    // procedure constants
