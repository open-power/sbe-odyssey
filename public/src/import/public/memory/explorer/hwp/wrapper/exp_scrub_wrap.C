...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_scrub_wrap.C $ */
/*                                                                        */
...
/// @file exp_scrub_wrap.C
/// @brief Wrapper for calling exp_scrub hwp
///
...
static const std::string PROCEDURE = "exp_scrub_wrap";
void help()
{
    // build help message
    char outstr[256];
