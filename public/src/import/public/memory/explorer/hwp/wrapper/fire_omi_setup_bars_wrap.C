...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/fire_omi_setup_bars_wrap.C $ */
/*                                                                        */
...
/// @file fire_omi_setup_bars_wrap.C
/// @brief Wrapper for calling fire_omi_setup_bars hwp
///
...
static const std::string PROCEDURE = "fire_omi_setup_bars_wrap";
void help()
{
    // procedure constants
...
int main(int argc, char* argv[])
{
    ...
    do
    {
        ...
        while (ecmdConfigLooperNext(node_target, node_looper))
        {
            ...
            l_ocmb_target.chipType = "fire";
            l_ocmb_target.chipTypeState = ECMD_TARGET_FIELD_VALID;
            l_ocmb_target.chipUnitType = "mcc";
            l_ocmb_target.chipUnitTypeState = ECMD_TARGET_FIELD_VALID;
            l_ocmb_target.chipUnitNumState   = ECMD_TARGET_FIELD_WILDCARD;
            ...
            while(ecmdConfigLooperNext(l_ocmb_target, ocmb_looper))
            {
                ...
                fapi2::Target<fapi2::TARGET_TYPE_MCC> fapi_target(&l_ocmb_target);
