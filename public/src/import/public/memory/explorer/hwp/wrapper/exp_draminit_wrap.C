...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_draminit_wrap.C $ */
/*                                                                        */
...
/// @file exp_draminit_wrap.C
/// @brief Wrapper for calling exp_draminit hwp
///
...
static const std::string PROCEDURE = "exp_draminit_wrap";
void help()
{
    // procedure constants
