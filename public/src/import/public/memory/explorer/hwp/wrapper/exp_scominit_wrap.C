...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_scominit_wrap.C $ */
/*                                                                        */
...
/// @file exp_scominit_wrap.C
/// @brief Wrapper for calling exp_scominit hwp
///
...
static const std::string PROCEDURE = "exp_scominit_wrap";
void help()
{
    // procedure constants
