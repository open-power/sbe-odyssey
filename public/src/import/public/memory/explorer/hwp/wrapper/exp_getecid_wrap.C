...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_getecid_wrap.C $ */
/*                                                                        */
...
static const std::string PROCEDURE = "exp_getecid_wrap";
void help()
{
    // procedure constants
