...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_mss_memdiag_wrap.C $ */
/*                                                                        */
...
/// @file exp_mss_memdiag_wrap.C
/// @brief Wrapper for calling exp_mss_memdiag hwp
///
...
static const std::string PROCEDURE = "exp_mss_memdiag_wrap";

///
/// @brief Help function for wrapper
///
void help()
{
    // build help message
