...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/wrapper/exp_getidec_wrap.C $ */
/*                                                                        */
...
/// @file exp_getidec_wrap.C
/// @brief Wrapper for calling exp_getecid hwp
///
/// *HWP HWP Owner: Christian Geddes
/// *HWP HWP Backup: <none>
/// *HWP Team: Hostboot
/// *HWP Level: 2
...
static const std::string PROCEDURE = "exp_getidec_wrap";
void help()
{
    // procedure constants
