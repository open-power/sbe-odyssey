...
/*                                                                        */
/* $Source: public/src/import/public/memory/explorer/hwp/lib/ecc/exp_mbs_error_vector_trap.C $ */
/*                                                                        */
...
///
/// @file exp_mbs_error_vector_trap.C
...
///
template<>
void get_nce_galois<mss::mc_type::EXPLORER>( const fapi2::Target<fapi2::TARGET_TYPE_MEM_PORT>& i_target,
        const fapi2::buffer<uint64_t>& i_data,
        uint64_t& o_value)
{
    using TT = eccTraits<mss::mc_type::EXPLORER, fapi2::TARGET_TYPE_MEM_PORT>;
...
///
template<>
void get_nce_magnitude<mss::mc_type::EXPLORER>( const fapi2::Target<fapi2::TARGET_TYPE_MEM_PORT>& i_target,
        const fapi2::buffer<uint64_t>& i_data,
        uint64_t& o_value)
{
    using TT = eccTraits<mss::mc_type::EXPLORER, fapi2::TARGET_TYPE_MEM_PORT>;
...
///
template<>
void get_tce_galois<mss::mc_type::EXPLORER>( const fapi2::Target<fapi2::TARGET_TYPE_MEM_PORT>& i_target,
        const fapi2::buffer<uint64_t>& i_data,
        uint64_t& o_value)
{
    using TT = eccTraits<mss::mc_type::EXPLORER, fapi2::TARGET_TYPE_MEM_PORT>;
...
///
template<>
void get_tce_magnitude<mss::mc_type::EXPLORER>( const fapi2::Target<fapi2::TARGET_TYPE_MEM_PORT>& i_target,
        const fapi2::buffer<uint64_t>& i_data,
        uint64_t& o_value)
{
