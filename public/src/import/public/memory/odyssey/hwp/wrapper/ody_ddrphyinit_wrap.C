...
/*                                                                        */
/* $Source: public/src/import/public/memory/odyssey/hwp/wrapper/ody_ddrphyinit_wrap.C $ */
/*                                                                        */
...
/// @file ody_ddrphyinit_wrap.C
/// @brief Wrapper for calling ody_ddrphyinit hwp
///
...
static const std::string PROCEDURE = "ody_ddrphyinit_wrap";
void help()
{
    // procedure constants
