...
/*                                                                        */
/* $Source: public/src/import/public/memory/odyssey/hwp/wrapper/ody_draminit_mc_wrap.C $ */
/*                                                                        */
...
/// @file ody_draminit_mc_wrap.C
/// @brief Wrapper for calling ody_draminit_mc_wrap hwp
///
...
static const std::string PROCEDURE = "ody_draminit_mc_wrap";
void help()
{
    // procedure constants
