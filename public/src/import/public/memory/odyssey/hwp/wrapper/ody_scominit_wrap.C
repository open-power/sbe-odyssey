...
/*                                                                        */
/* $Source: public/src/import/public/memory/odyssey/hwp/wrapper/ody_scominit_wrap.C $ */
/*                                                                        */
...
/// @file ody_scominit_wrap.C
/// @brief Wrapper for calling ody_scominit hwp
///
...
static const std::string PROCEDURE = "ody_scominit_wrap";
void help()
{
    // procedure constants
