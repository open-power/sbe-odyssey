...
#
# $Source: public/src/import/public/memory/generic/memory/lib/00gen_accessors.mk $
#
...
# Avoiding conflicts with redeclaration of attrs in mss_generic_system_attribute_getters.H
# generated by 00gen_system_accessors.mk. So removing it.
SOURCES += $(MSS_PATH)/generic/xml/attribute_info/generic_dq_attributes.xml
ALL_GEN_XML_SOURCES := $(shell find $(MSS_PATH)/generic/xml/attribute_info/ -name '*.xml'| sort)
SOURCES += $(filter-out $(MSS_PATH)/generic/xml/attribute_info/generic_memory_mrw_attributes.xml, $(ALL_GEN_XML_SOURCES))

TARGETS += mss_generic_attribute_getters.H
TARGETS += mss_generic_attribute_setters.H
