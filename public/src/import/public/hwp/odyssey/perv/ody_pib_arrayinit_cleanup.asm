...
/* IBM_PROLOG_END_TAG                                                     */
//------------------------------------------------------------------------------
/// @brief Array Init cleanup for PIB clock region
//------------------------------------------------------------------------------
...
ody_pib_arrayinit_cleanup:
        // Call the poz_pib_arrayinit_cleanup module with correct parameters
        #define I_CLOCK_REGIONS PIB_CLOCK_REGION
        #include "poz_pib_arrayinit_cleanup.asm"
