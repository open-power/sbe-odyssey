...
/*                                                                        */
/* $Source: public/src/import/public/hwp/odyssey/perv/ody_extract_sbe_rc.C $ */
/*                                                                        */
                              ...
                              bool i_use_scom)
{
    ...
    if ((PIBMEM_MIN_RANGE <= ppe_dbg_loc) && (ppe_dbg_loc <= PIBMEM_MAX_RANGE))
    {
        ...
        if((l_data64_dbg[0].getBit<31>()) && (l_data32_magicbyte == 0xA5))
        {
            ...
            l_data64_dbg[3].extractToRight(l_data64_lfr0  , 0, 64);
            l_data64_dbg[4].extractToRight(l_data64_lfr1  , 0, 64);
            l_data64_dbg[5].extractToRight(l_data64_eistr  , 0, 64);
            l_data64_dbg[6].extractToRight(l_data64_eimr  , 0, 64);
            l_data64_dbg[7].extractToRight(l_data64_eisr  , 0, 64);
            l_data64_dbg[8].extractToRight(l_data64_spi0_status, 0, 64);
            l_data64_dbg[9].extractToRight(l_data64_spi0_config, 0, 64);
            l_data64_dbg[10].extractToRight(l_data64_spi0_clock_config, 0, 64);
            l_data64_dbg[11].extractToRight(l_data64_otp_status, 0, 64);
