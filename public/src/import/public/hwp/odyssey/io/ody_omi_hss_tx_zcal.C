...
/*                                                                        */
/* $Source: public/src/import/public/hwp/odyssey/io/ody_omi_hss_tx_zcal.C $ */
/*                                                                        */
                               ...
                               const uint32_t& i_lane)
{
    ...
    rmwIoHardwareReg(i_target, l_addr, c_preVal, c_segBit, segLens[0]);

    // Set P Pre2
    FAPI_DBG("Setting P Pre2 0x%x", c_preVal);
    l_addr = buildAddr(i_baseAddr, i_group, i_lane, pSegRegisters[1]);
    rmwIoHardwareReg(i_target, l_addr, c_preVal, c_segBit, segLens[1]);
