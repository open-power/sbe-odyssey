...
/*                                                                        */
/* $Source: public/src/import/public/initfiles/pt/scom/pt_core_scom.C $   */
/*                                                                        */
...
fapi2::ReturnCode pt_core_scom(const fapi2::Target<fapi2::TARGET_TYPE_CORE>& TGT0,
...
{
    {
        ...
        {
            FAPI_TRY(fapi2::getScom( TGT0, 0x20020442ull, l_scom_buffer ));
            ...
            FAPI_TRY(fapi2::putScom(TGT0, 0x20020442ull, l_scom_buffer));
        }
