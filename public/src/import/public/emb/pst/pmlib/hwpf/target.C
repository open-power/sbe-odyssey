...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/hwpf/target.C $        */
/*                                                                        */
...
ReturnCode plat_TargetsInit(uint32_t i_quad_id)
{
    ...
    Target<TARGET_TYPE_COMPUTE_CHIP> chip_target(createPlatTargetHandle<TARGET_TYPE_COMPUTE_CHIP>(0));
...
Target<TARGET_TYPE_COMPUTE_CHIP> plat_getChipTarget()
{
    return ((Target<TARGET_TYPE_COMPUTE_CHIP>)G_vec_targets.at(0));
}
...
TargetType plat_target_handle_t::getFapiTargetType() const
{
    ...
    {
        case PPE_TARGET_TYPE_COMPUTE_CHIP:
            l_targetType = TARGET_TYPE_COMPUTE_CHIP;
            break;
