...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/ipc/ipc_macros.h $     */
/*                                                                        */
...
#define IPC_FUNCIDS_MT_START \
    IPC_MT_START = (int)((IPC_TARGET_MASK | IPC_FLAG_MT | IPC_FLAG_VALID | (((uint32_t)((uint8_t)PMHW_INST_ID_SELF)) << 16)) - 1),
...
///////////////////////////////////////////////////////////////////////////////
#define IPC_ST_NUM_FUNCIDS IPC_ST_TARGET_NUM_FUNCIDS(PMHW_INST_ID_SELF)
