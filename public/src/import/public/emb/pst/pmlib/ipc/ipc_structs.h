...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/ipc/ipc_structs.h $    */
/*                                                                        */
...
typedef struct
{
    ...
    ipc_msg_t*     cbufs[PLATHW_MAX_INSTANCES][IPC_CBUF_SIZE];
    uint8_t        pad[16];
...
typedef struct
{
    ipc_target_t      targets[PLATHW_MAX_INSTANCES]; //880 bytes
} ipc_shared_data_t;
