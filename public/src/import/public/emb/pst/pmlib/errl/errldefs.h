...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/errl/errldefs.h $      */
/*                                                                        */
...
/**
 * @file errldefs.h
 * @brief Hcode Error Log Definitions
 */
...
#define ERRL_SLOT_MASK_QME_INFO_BASE  0x40000000   ///< QME Infomational Log Base
...
/**
 * @brief Index into array of error log entries in hcode_error_table_t
...
/**
 * @brief Structure to house-keep specific error log related metadata until it is
...
/**
 * @brief Structure to configure GPE specific metadata for error logging that is
