...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/errl/errlutil.h $      */
/*                                                                        */
...
/**
 * @file errlutil.h
 * @brief Hcode Error Log Utilities
 */
...
/// @param [in] i_userData1 [uint32_t] User data to add to SRC words of Error Log
/// @param [in] i_userData2 [uint32_t] User data to add to SRC words of Error Log
/// @param [in] i_userData3 [uint32_t] User data to add to SRC words of Error Log
...
///
/// @param [in] i_elogOrig [uint16_t] Origin of the error log
/// @param [in] i_userData1 [uint32_t] User data to add to SRC words of Error Log
/// @param [in] i_userData2 [uint32_t] User data to add to SRC words of Error Log
/// @param [in] i_userData3 [uint32_t] User data to add to SRC words of Error Log
/// @param [in] p_usrDtls [errlDataUsrDtls_t*] Linked list of user detail sections to
...
/// @param[out] o_status [uint32_t] See errlStatusCodes
/// @param[in]  i_elogSectn [uint32_t] Error log section
///
