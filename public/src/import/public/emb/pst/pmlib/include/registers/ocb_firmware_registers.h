...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/include/registers/ocb_firmware_registers.h $ */
/*                                                                        */
...
typedef union ocb_oisr0
{
    ...
    {
#ifdef _BIG_ENDIAN
        uint32_t interrupt_status_n : 32;
#else
        uint32_t interrupt_status_n : 32;
#endif // _BIG_ENDIAN
    } fields;
...
typedef union ocb_o2actrlfn
{
    ...
    {
#ifdef _BIG_ENDIAN
        uint32_t o2a_frame_size_n : 6;
        uint32_t o2a_out_count1_n : 6;
        uint32_t o2a_in_delay1_n : 6;
        uint32_t o2a_in_count1_n : 6;
...
typedef union ocb_o2actrlsn
{
    ...
    {
#ifdef _BIG_ENDIAN
        uint32_t o2a_out_count2_n : 6;
        uint32_t o2a_in_delay2_n : 6;
        uint32_t o2a_in_count2_n : 6;
...
typedef union ocb_o2actrl1n
{
    ...
    {
#ifdef _BIG_ENDIAN
        uint32_t o2a_bridge_enable_n_a : 1;
        uint32_t o2a_bridge_enable_n_b : 1;
        uint32_t reserved1 : 2;
        uint32_t o2a_clock_divider_n : 10;
        uint32_t o2actrl1n_reserved_14_16 : 3;
        uint32_t o2a_nr_of_frames_n : 1;
...
typedef union ocb_o2actrl2n
{
    ...
    {
#ifdef _BIG_ENDIAN
        uint32_t o2a_inter_frame_delay_n : 16;
        uint32_t reserved1 : 16;
#else
        uint32_t reserved1 : 16;
        uint32_t o2a_inter_frame_delay_n : 16;
