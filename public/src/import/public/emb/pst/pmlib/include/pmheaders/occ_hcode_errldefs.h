...
/*                                                                        */
/* $Source: public/src/import/public/emb/pst/pmlib/include/pmheaders/occ_hcode_errldefs.h $ */
/*                                                                        */
...
/// @brief consists of the fields below followed by the actual data the user is
/// trying to collect.
...
/// Error Log User Details Entry
typedef struct ErrlUserDetailsEntry ErrlUserDetailsEntry_t;

/// @brief consists of the fields below followed by each individual User Details Entry
/// structure & data
/// NOTE: A data pointer field is NOT defined but rather inferred here.  In the
///       error log contents, the user will see all the subsequent fields followed
...
struct ErrlUserDetails
{
    ...
    uint8_t     iv_reserved3: 7;        ///< Reserved
