...
/*                                                                        */
/* $Source: public/src/import/public/emb/odyssey/io/ioo/tx_zcal_tdr.h $   */
/*                                                                        */
...
bool tx_zcal_tdr_capt_match_mult_rds(t_gcr_addr* gcr_addr_i, uint32_t match_value_i, uint32_t times_i);
...
uint32_t tx_zcal_tdr_toThermWithHalf( const uint32_t i_dec, const uint32_t i_width );
