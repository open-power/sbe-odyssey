...
//tx_tdr_dac_cntl          |pg  | 0x00   | 0x66|0x66|0x9A|0x9A|0x66|0x66|0x9A|0x9A|0  8 tx_ctl_cntl4_pg
...
//tx_pcie_idle_del_sel     |pg  | 0x4    | n/a | n/a|n/a |n/a |n/a |n/a |n/a |n/a |0  4 tx_ppe_mode10_pg
//tx_pcie_loz_del_sel      |pg  | 0x3    | n/a | n/a|n/a |n/a |n/a |n/a |n/a |n/a |4  4 tx_ppe_mode10_pg
                       ...
                       uint16_t tx_idle_ovr_alias, uint16_t fail_mask)
{
    ...
    put_ptr_field(gcr_addr, tx_tdr_cntl_alias, tx_tdr_cntl_alias_in , fast_write); //pg
...
int tx_txidle_bist(t_gcr_addr* gcr_addr, int tx_bist_enable_ls, int tx_bist_enable_hs)
{
    ...
    over_all_fail = tx_idle_tests(gcr_addr, tdr_cntl_102_clp_padp_offset , expect_1 , tx_idle_mode_ovr_alias_1111,
                                  t1_p_pad_fail_exp_1);

    //Test 2 LOZ=1 expect 0 on read, n pad selected
    set_debug_state(0x0142, DBG_LVL); // test2  102_n_idle_1111_exp1
    over_all_fail = over_all_fail | tx_idle_tests(gcr_addr, tdr_cntl_102_clp_padn_offset , expect_1 ,
    ...
    over_all_fail = over_all_fail | tx_idle_tests(gcr_addr, tdr_cntl_154_clp_padp_offset , expect_0 ,
    ...
    over_all_fail = over_all_fail | tx_idle_tests(gcr_addr, tdr_cntl_154_clp_padn_offset , expect_0 ,
    ...
    over_all_fail = over_all_fail | tx_idle_tests(gcr_addr, tdr_cntl_102_clp_padp_offset , expect_1 ,
