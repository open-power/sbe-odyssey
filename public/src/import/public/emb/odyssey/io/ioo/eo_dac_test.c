...
/*                                                                        */
/* $Source: public/src/import/public/emb/odyssey/io/ioo/eo_dac_test.c $   */
/*                                                                        */
...
int eo_dac_test(t_gcr_addr* io_gcr_addr, const uint32_t i_lane_mask)
{
    //start eo_dac_test
    set_debug_state(0x5180);
    int status = rc_no_error;

    //This field is used to programmably set the number of RX lanes in the group serviced by the PPE thread.
