...
/*                                                                        */
/* $Source: public/src/import/public/emb/odyssey/io/ioo/eo_qpa.h $        */
/*                                                                        */
...
int nedge_seek_step (t_gcr_addr *gcr_addr, t_bank bank, unsigned int Dstep, unsigned int Estep, bool dirL1R0, bool noBER, t_seek seek_edge, int *pr_vals);//, int ber_lim
...
int nedge_seek_multistep (t_gcr_addr *gcr_addr, t_bank bank, unsigned int Dstep, unsigned int Estep, bool dirL1R0, bool noBER, t_seek seek_edge, int *pr_vals);//, int ber_lim
*/
